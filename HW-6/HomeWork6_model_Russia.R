...
#отобрали данные
sber_monthly<-filter(master_sber, region=='Алтайский край' & date>='2013-01-15')
...
rownames(df_sber_monthly) <- as.vector(as.character(df_sber_monthly[,2]))
ready_prices <- df_sber_monthly[,3:ncol(df_sber_monthly)]
